...
class BaseOptions():
    ...
    def parse_jupyter(self,save=False):
        
        argstr = ["--name","face","--dataset_mode", "paired", "--adaptive_spade", "--warp_ref"," --spade_combine", "--batchSize","8","--no_flow_gt"]
        ...
        opt = parser.parse_args(argstr_part)
