...
class GenGeneralConvBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, fused=False, initial=False):
        """
        ...
        self.adain1 = AdaptiveInstanceNorm(out_channels, out_channels)
        ...
        self.adain2 = AdaptiveInstanceNorm(out_channels, out_channels)
